...
export const resume = {
    ...
    projects: [
        ...
        },
        {
            ...
            link: "https://github.com/yourusername/image-converter",
        },
        {
            name: "PDF Chat Assistant",
            description:
                "A chatbot app that allows users to upload PDFs and ask natural language questions based on the content. Built using Node.js backend with vector embeddings (Ollama/Mistral), LangChain, and Pinecone. Streams word-by-word AI responses. Frontend powered by React, styled with Tailwind CSS.",
            link: "https://github.com/yourusername/pdf-chat-assistant",
        },
        {
            name: "Resume Builder CMS",
            description:
